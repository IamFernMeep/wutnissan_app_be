...
// ==================================================
// GET /api/v1/jobsheets/today/pending
// ==================================================
export async function getTodayPending(req, res, next) {
    try {
        const jobsheetResult = await Jobsheet.findTodayPending();
        const appointmentResult = await Appointment.findToday();
        ...
        res.json({
            ...
            data: {
                total:
                    jobsheetResult.total +
                    appointmentResult.total,

                jobsheets: jobsheetResult.jobsheets,
